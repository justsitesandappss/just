...
export default function TalentInesHmz(props: TalentInesHmzProps) {
    const {
        ...
        alias = "La Queen",
        handle = "@ineshmz",
        tagline = "Beauté · Mode · Lifestyle · Dubaï · Téléréalité 2.0",
        bio = "L'influenceuse glamour par excellence — et surtout la fameuse 'Inès' de l'univers Karim Lipton. Figure incontournable du storytelling quotidien de la Team Lipton, elle a su capitaliser sur cette exposition pour construire sa propre communauté. Entre lifestyle dubaïote, mode, beauté et dramas savoureux, Ines incarne le luxe accessible.",
        location = "Dubaï / Val-de-Marne (94)",
        stat1 = "600K+",
        stat1Label = "Abonnés Snapchat",
        stat2 = "400K",
        stat2Label = "Abonnés Instagram",
        stat3 = "350K",
        stat3Label = "Abonnés TikTok",
        stat4 = "8M+",
        stat4Label = "Vues mensuelles",
        stat5 = "800K+",
        stat5Label = "Reach stories",
        stat6 = "9.4%",
        stat6Label = "Taux d'engagement",
        snapFollowers = "600K+",
        snapDesc = "Le cœur de son audience. Ines partage son quotidien entre Dubaï et la France — rendez-vous esthétiques, hauls mode, dramas avec Karim, moments de vie glamour. Son audience féminine est hyper-fidèle et ultra-réactive.",
        instaFollowers = "400K",
        instaDesc = "Sa vitrine mode et beauté. Photos soignées, looks travaillés, promotions de cliniques esthétiques, partenariats mode. Chaque post est un catalogue lifestyle aspirationnel.",
        tiktokFollowers = "350K",
        tiktokDesc = "Formats courts : routines beauté, get ready with me, réactions aux dramas, duos avec Karim. L'algorithme adore son contenu émotionnel et esthétique.",
        youtubeFollowers = "60K",
        youtubeDesc = "Vlogs Dubaï, routines beauté longues, storytimes et behind the scenes de sa vie avec la Team Lipton.",
        pillar1Title = "La Beauté & L'Esthétique",
        pillar1Desc = "Ines est l'ambassadrice parfaite des cliniques esthétiques, des marques de skincare et de beauté premium. Elle documente ses rendez-vous, partage ses résultats, recommande ses praticiens — avec une transparence qui crée de la confiance et convertit massivement.",
        pillar1Icon = "💎",
        pillar2Title = "La Téléréalité 2.0",
        pillar2Desc = "Sa relation tumultueuse avec Karim Lipton est un feuilleton que des centaines de milliers de personnes suivent quotidiennement. Les crises de jalousie, les réconciliations, les fausses ruptures — c'est du storytelling pur jus qui génère un engagement délirant.",
        pillar2Icon = "❤️‍🔥",
        pillar3Title = "Le Lifestyle Dubaï",
        pillar3Desc = "Brunch en rooftop, shopping au Dubai Mall, couchers de soleil sur la Marina — Ines projette un lifestyle dubaïote aspirationnel mais crédible. Elle n'est pas dans le luxe inaccessible, elle est dans le 'ça pourrait être moi'.",
        pillar3Icon = "🌴",
        pillar4Title = "La Mode & Les Hauls",
        pillar4Desc = "Hauls Zara, Shein, mais aussi pièces plus premium — Ines mélange les gammes avec un œil sûr. Ses hauls génèrent des ventes directes et ses looks sont reproduits par sa communauté.",
        pillar4Icon = "👗",
        ascensionText = "Ines a explosé grâce à l'univers Karim Lipton — mais elle a su transformer cette exposition en empire personnel. Là où beaucoup de 'copines de' restent dans l'ombre, Ines a construit sa propre audience, sa propre identité de marque, et ses propres partenariats.",
        categories = "Beauté, Mode, Lifestyle, Esthétique, Dubaï, Drama",
        collab1 = "Placement beauté / esthétique",
        collab1Desc = "Intégration dans ses routines beauté, ses rendez-vous en clinique, ses stories quotidiennes. Audience féminine ultra-ciblée et conversion prouvée.",
        collab2 = "Haul & Try-on mode",
        collab2Desc = "Vidéo dédiée avec essayage de votre collection — le format qui génère le plus de clics et de ventes directes chez Ines.",
        collab3 = "Ambassadrice de marque",
        collab3Desc = "Partenariat long terme avec présence régulière sur ses réseaux, événements et contenus exclusifs. Parfait pour beauté, mode et wellness.",
        collab4 = "Contenu lifestyle Dubaï",
        collab4Desc = "Intégration de votre marque dans son quotidien dubaïote — hôtels, restaurants, expériences. Le lifestyle aspirationnel qui fait rêver et convertit.",
        brandsWorked = "Beauté, Esthétique, Mode, Skincare, Voyage, Luxe accessible, Bien-être, Food",
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        {["Snapchat", "Instagram", "TikTok", "YouTube"].map(
                            (platform) => (
                                <li
                                    key={platform}
                                    style={{
