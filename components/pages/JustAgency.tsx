...
function useResponsive(ref: RefObject<HTMLDivElement | null>) {
  ...
  useEffect(() => {
    ...
    const update = () => {
      const width = Math.max(
        320,
        Math.round(node.getBoundingClientRect().width || window.innerWidth)
      )
      setSize({ width })
    }
  ...
  return {
    vw: size.width,
    mobile: size.width <= 767,
    tablet: size.width <= 1024,
  }
}
...
function Marquee({ items, speed = 35 }: { items: string[]; speed?: number }) {
  ...
  if (reduceMotion) {
    return (
      <section
        aria-label="Prestations premium"
        style={{
          width: "100%",
          padding: "18px 0",
...
function ServiceCard({
  ...
  return (
    <motion.article
      ...
      viewport={{ once: true, amount: 0.2 }}
      transition={
        reduceMotion ? undefined : { duration: 0.6, delay, ease: EASE }
      }
      ...
      <input
        ...
        style={{
          ...
          borderBottom: `1px solid ${
            error ? COLORS.error : focused ? COLORS.text : COLORS.border
          }`,
          padding: "30px 0 16px",
          fontFamily: BODY,
          fontSize: 17,
...
export default function JustAgencyPage() {
  ...
  const heroMinHeight = mobile
    ? 720
    : tablet
      ? 820
      : clampNumber(820, Math.round(vw * 0.62), 980)
  const heroPadding = mobile
    ? "64px 24px 72px"
    : tablet
      ? "72px 40px 84px"
      : "60px 72px 80px"
  const pagePadding = mobile
    ? "36px 24px"
    : tablet
      ? "60px 40px"
      : "80px 72px"
  ...
  const services = [
    {
      title: "Jets & Hélicoptères",
      desc: "Vols charter, repositionnements, transferts privés et départs organisés dans des délais extrêmement courts.",
    },
    {
      title: "Yachts & Croisières",
      desc: "Location de yachts, itinéraires exclusifs, équipage dédié et organisation complète de l'expérience à bord.",
    },
    {
      title: "Supercars & Prestige",
      desc: "Ferrari, Lamborghini, Rolls-Royce et autres véhicules d'exception avec ou sans chauffeur.",
    },
    {
      title: "Villas & Châteaux",
      desc: "Sélection de propriétés haut de gamme avec services sur place, sécurité et logistique dédiée.",
    },
    {
      title: "Personal Shopping",
      desc: "Accès privilégié aux collections, pièces réservées, sourcing, stylisme et accompagnement personnalisé.",
    },
    {
      title: "Gastronomie Privée",
      desc: "Chefs privés, tables rares, dîners signatures et expériences culinaires pensées au millimètre.",
    },
    {
      title: "Événements & Accès",
      desc: "Premières, galas, backstage, front row et accès complexes à obtenir par les canaux classiques.",
    },
    {
      title: "Joaillerie & Horlogerie",
      desc: "Recherche de pièces rares, montres de collection, créations sur commande et accompagnement d'acquisition.",
    },
    {
      title: "Gestion de Vie",
      desc: "Coordination du quotidien, assistance logistique, administratif sensible et traitement rapide des imprévus.",
    },
  ]
  ...
  const validate = useCallback(() => {
    ...
    if (!formData.name.trim()) {
      nextErrors.name = "Merci d'indiquer votre nom."
    }
    ...
    if (!formData.message.trim()) {
      nextErrors.message = "Merci de préciser votre demande."
    } else if (formData.message.trim().length < 10) {
      nextErrors.message = "Votre message est un peu trop court."
    }
  ...
  const handleSubmit = useCallback(
    async (event: FormEvent<HTMLFormElement>) => {
      ...
      if (!WEB3FORMS_ACCESS_KEY) {
        setStatus("error")
        setLiveMsg("Clé Web3Forms introuvable.")
        return
      }
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <motion.span
            ...
            animate={
              reduceMotion
                ? undefined
                : { scale: [1, 1.35, 1], opacity: [0.4, 0.95, 0.4] }
            }
            transition={
              reduceMotion ? undefined : { duration: 2.4, repeat: Infinity }
            }
            style={{
              width: 6,
              height: 6,
        ...
        <div
          style={{
            maxWidth: Math.min(1280, vw - (mobile ? 48 : tablet ? 80 : 144)),
            position: "relative",
            zIndex: 1,
          }}
        >
        ...
        >
          Just Agency est une conciergerie de luxe sur mesure. Nous organisons
          jets privés, villas d&apos;exception, supercars, expériences VIP et
          services exclusifs pour une clientèle exigeante en France et à
          l&apos;international.
        </p>
      </header>
      ...
      <main>
        <section
          aria-labelledby="just-agency-visual-title"
          style={{
            width: "100%",
            height: mobile
              ? 520
              : tablet
                ? 620
                : clampNumber(620, Math.round(vw * 0.5), 820),
            position: "relative",
            overflow: "hidden",
          }}
        >
          <Image
            src="https://cdn.jsdelivr.net/gh/justsitesandappss/Assets@main/justagency-sieges.jpg"
            alt="Salon haut de gamme illustrant l’univers de la conciergerie de luxe Just Agency."
            fill
            sizes="100vw"
            loading="lazy"
          ...
          <div
            ...
            style={{
              ...
              inset: 0,
              background:
                "linear-gradient(to bottom, rgba(0,0,0,0.88) 0%, rgba(0,0,0,0.34) 30%, transparent 50%)",
              pointerEvents: "none",
            }}
          />
          <div
            ...
            style={{
              ...
              inset: 0,
              background:
                "linear-gradient(to top, rgba(0,0,0,0.88) 0%, rgba(0,0,0,0.34) 42%, rgba(0,0,0,0.14) 100%)",
              pointerEvents: "none",
            }}
          />
          ...
          <div
            style={{
              position: "absolute",
              bottom: mobile ? 28 : 56,
              left: mobile ? 24 : tablet ? 40 : 72,
              right: mobile ? 24 : tablet ? 40 : 72,
            }}
          >
            <p
              style={{
            ...
            <Reveal>
              <div style={{ marginBottom: mobile ? 48 : 72 }}>
                ...
                >
                  ...
                  votre ambition, on a l&apos;entité et l&apos;expertise qu&apos;il
                  vous faut. Remplissez le formulaire, on revient vers vous sous
                  24h.
                </p>
              </div>
            </Reveal>
                          ...
                          <AnimatePresence>
                            {status === "error" && (
                              ...
                              >
                                ...
                                {liveMsg &&
                                liveMsg !== "Une erreur est survenue."
                                  ? liveMsg
              ...
              <Reveal delay={0.15}>
                ...
                >
                  ...
                  >
                    ...
                    >
                      &ldquo;Chaque projet commence par une conversation. La
                      vôtre commence ici.&rdquo;
                    </blockquote>
                  </div>
                </aside>
              </Reveal>
