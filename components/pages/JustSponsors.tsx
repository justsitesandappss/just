...
const SPONSOR_SEEDS = [
  { index: 1, name: "Konbini", cat: "Média & Divertissement" as SponsorCategory },
  { index: 2, name: "Warner Bros", cat: "Média & Divertissement" as SponsorCategory },
  { index: 3, name: "Meta", cat: "Média & Divertissement" as SponsorCategory },
  { index: 4, name: "Canal+", cat: "Média & Divertissement" as SponsorCategory },
  { index: 5, name: "Allociné", cat: "Média & Divertissement" as SponsorCategory },
  { index: 6, name: "Prime Video", cat: "Média & Divertissement" as SponsorCategory },
  { index: 7, name: "TikTok", cat: "Média & Divertissement" as SponsorCategory },
  { index: 8, name: "Oracle", cat: "Corporate & Industrie" as SponsorCategory },
  { index: 9, name: "Fnac", cat: "Retail & Tech" as SponsorCategory },
  { index: 10, name: "Darty", cat: "Retail & Tech" as SponsorCategory },
  { index: 11, name: "Geox", cat: "Retail & Tech" as SponsorCategory },
  { index: 12, name: "Volpy", cat: "Retail & Tech" as SponsorCategory },
  { index: 13, name: "Fruitz", cat: "Food & Restauration" as SponsorCategory },
  { index: 14, name: "Honor", cat: "Sport, Lifestyle & Tourisme" as SponsorCategory },
  { index: 15, name: "DeepCool", cat: "Retail & Tech" as SponsorCategory },
  { index: 16, name: "Konix", cat: "Retail & Tech" as SponsorCategory },
  { index: 17, name: "Crazy Tiger", cat: "Food & Restauration" as SponsorCategory },
  { index: 18, name: "Chicken Street", cat: "Food & Restauration" as SponsorCategory },
  { index: 19, name: "Venum", cat: "Sport, Lifestyle & Tourisme" as SponsorCategory },
  { index: 20, name: "Chamas Tacos", cat: "Food & Restauration" as SponsorCategory },
  { index: 21, name: "Five Pizza", cat: "Food & Restauration" as SponsorCategory },
  { index: 22, name: "Planète Rap", cat: "Média & Divertissement" as SponsorCategory },
  { index: 23, name: "Unisport", cat: "Sport, Lifestyle & Tourisme" as SponsorCategory },
  { index: 24, name: "Black & White", cat: "Food & Restauration" as SponsorCategory },
  { index: 25, name: "Sanofi", cat: "Corporate & Industrie" as SponsorCategory },
  { index: 26, name: "SNCF", cat: "Corporate & Industrie" as SponsorCategory },
  { index: 27, name: "TotalEnergies", cat: "Corporate & Industrie" as SponsorCategory },
  { index: 28, name: "Renault", cat: "Corporate & Industrie" as SponsorCategory },
  { index: 29, name: "Paris 2024", cat: "Sport, Lifestyle & Tourisme" as SponsorCategory },
  { index: 30, name: "PSG", cat: "Sport, Lifestyle & Tourisme" as SponsorCategory },
  { index: 31, name: "Get Your Guide", cat: "Sport, Lifestyle & Tourisme" as SponsorCategory },
  { index: 32, name: "Les Missions Locales", cat: "Corporate & Industrie" as SponsorCategory },
  { index: 33, name: "Hurghada Dream", cat: "Sport, Lifestyle & Tourisme" as SponsorCategory },
  { index: 34, name: "Viseon", cat: "Retail & Tech" as SponsorCategory },
  { index: 35, name: "Safe Fusion", cat: "Services & Partenaires" as SponsorCategory },
  { index: 36, name: "Just Media 4 You", cat: "Services & Partenaires" as SponsorCategory },
]
...
export default function JustSponsorsPage() {
  ...
  const allSponsors: SponsorItem[] = useMemo(() => SPONSOR_SEEDS.map(seed => ({ name: seed.name, imageUrl: undefined, cat: seed.cat })), [])
